...
znReady(function() {
    ...
    (function() {
        ...
        (function() {
            (function() {
                for (var e = document.getElementById("znid-999831900775"), t = e.querySelectorAll(":scope > .zn-element > .zn-accordion > .zn-accordion-section > .zn-accordion-handle"), n = "multiple", i = 0; i < t.length; i++) t[i].addEventListener("click", (function() {
